...
import { registerSchema } from "../validations/regsiter-validation";
import { doRegister } from "../api/user-api";
import { useNavigate } from "react-router-dom";
import React, { useState } from 'react';

// Modern theme (your original styles)
const theme = {
        ...
        <CardContent>
          ...
          <form onSubmit={handleSubmit(registerSubmit)} className="space-y-5">
            <div className="grid w-full items-center gap-2">
              ...
              />
              {errors.name && <p className={theme.errorText}>{errors.name.message}</p>}
            </div>
            ...
            <div className="grid w-full items-center gap-2">
              ...
              <Input
                ...
                className={theme.input}
              />
              {errors.email && <p className={theme.errorText}>{errors.email.message}</p>}
            </div>
            ...
            <div className="grid w-full items-center gap-2">
              ...
              <Input
                ...
                className={theme.input}
              />
              {errors.password && <p className={theme.errorText}>{errors.password.message}</p>}
            </div>
